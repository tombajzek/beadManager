...
//$resultid2= mysql_query("select * from beads where beadType = '" . $beadType . "'" .  "order by beadType,baseKey" ,$Catalog);
if ($beadType=="PT" || $beadType=="PTI" || $beadType=="PTB" || $beadType=="PTDB" || $beadType=="PTT" ) {
$resultid2= mysql_query("select * from beads where beadType = '" . $beadType . "'" .  " order by baseKey desc" ,$Catalog);
} else
{
...
print  $row['beadNo']." - $". $row['price']. " - [". $qtyD . "] [" . $qtyS . "] - [" . $qtyQF . "]";
